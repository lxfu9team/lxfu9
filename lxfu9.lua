...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./lxfu9.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BK", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S lxfu9 -X kill
screen -S lxfu9 ./lxfu9
done
]])  
file:close() 
...
if tonumber(user_id) == tonumber(950558270) then  
var = true  
...
local lxfu9_Msg = ''  
if msgs < 100 then 
lxfu9_Msg = 'غير متفاعل😔💔' 
elseif msgs < 200 then 
lxfu9_Msg = 'بده يتحسن😕💔' 
elseif msgs < 400 then 
lxfu9_Msg = 'شبه متفاعل😗👻' 
elseif msgs < 700 then 
lxfu9_Msg = 'متفاعل😍🙊' 
elseif msgs < 1200 then 
lxfu9_Msg = 'متفاعل قوي😍✔️' 
elseif msgs < 2000 then 
lxfu9_Msg = 'متفاعل جدا😍💘' 
elseif msgs < 3500 then 
lxfu9_Msg = 'اقوى تفاعل🙊👻'  
elseif msgs < 4000 then 
lxfu9_Msg = 'متفاعل نار😍🔥' 
elseif msgs < 4500 then 
lxfu9_Msg = 'قمة التفاعل🤸‍♂️😻' 
elseif msgs < 5500 then 
lxfu9_Msg = 'اقوى متفاعل😳😻' 
elseif msgs < 7000 then 
lxfu9_Msg = 'ملك التفاعل🤴😍' 
elseif msgs < 9500 then 
lxfu9_Msg = 'امبروطور التفاعل💂‍♀️😻' 
...
--------------------------------------------------------------------------------------------------------------
function Sourcelxfu9(msg,data) -- بداية العمل
if msg then
...
{'تعطيل الاذاعه','تفعيل الاذاعه','الاشتراك الاجباري 🚸'},
...
send(msg.chat_id_, msg.id_,lxfu9_Msg) 
return false  
end 
if text then    
...
os.execute('wget https://raw.githubusercontent.com/lxfu9BOT/lxfu9/master/lxfu9.lua')
...
send(msg.chat_id_, msg.id_,'📌¦ عدد المجموعات الان » { '..#group..' }'..lxfu9k..''..lxfu9..'\n*📌┇ الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
usertext = '\n👤¦ العضو » ['..result.title_..'](t.me/'..(username or 'lxfu9')..')'
...
usertext = '\n👤¦ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'lxfu9')..')'
status  = '\n📫¦ تم ترقيته مطور في البوت'
...
--------------------------------------------------------------------------------------------------------------
if lxfu9_Msg and not Special(msg) then  
local lxfu9_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if lxfu9_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n📛¦["..lxfu9_Msg.."] \n") 
else
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/lxfu9)}\n📛¦["..lxfu9_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
📮┇[قناه السورس](t.me/lxfu9) 


📂┇[كليشه التنصيب](https://t.me/lxfu9/23) 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'👤| بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'lxfu9')..') \n🔘| تـم قفـل الدردشه ')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤| بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'lxfu9')..') \n🔘| تـم قفـل التاك بالكتم ')  
end,nil)   
...
t = "\n⛔¦ قائمة المنع \n━━━━━━━━━━━━━\n"
for k,v in pairs(list) do  
local lxfu9_Msg = database:get(bot_id.."Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..''..k..'- '..v..' » {'..lxfu9_Msg..'}\n'    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n👤¦ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'lxfu9')..')'..'\n📬¦ تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,'['..lxfu9_Msg[math.random(#lxfu9_Msg)]..']') 
return false
end
...
lxfu9 = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(lxfu9)
...
--------------------------------------------------------------------------------------------------------------
Sourcelxfu9(data.message_,data)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
------------------------------------------------------------------------
local lxfu9bot = database:get(bot_id.."Add:Filter:Rp2"..text..result.chat_id_)   
if lxfu9bot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n📛¦["..lxfu9bot.."] \n") 
